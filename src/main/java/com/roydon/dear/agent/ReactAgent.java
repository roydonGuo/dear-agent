...
import com.roydon.dear.domain.agent.AgentState;
import com.roydon.dear.domain.agent.RoundMode;
import com.roydon.dear.domain.agent.SearchResult;
import com.roydon.dear.domain.agent.SimpleReactResult;
import com.roydon.dear.prompts.PlanExecutePrompts;
...
public class ReactAgent {
    ...
    public ReactAgent(String name, ChatModel chatModel, List<ToolCallback> tools, String systemPrompt, int maxRounds, ChatMemory chatMemory, List<Advisor> advisors, int maxReflectionRounds) {
        this.name = name;
